...
class Articulos_Model extends Model
{
    ...
    public function get()
    {
        ...
        try {
            ...
            $query = $this->db->connect()->query('SELECT id, nombre, descripcion, precio, estado, url_foto FROM productos');
    ...
    public function verArticulo($id)
    {
        $articulo = null;
        try {
            $query = $this->db->connect()->prepare('SELECT id, nombre, descripcion, precio, estado FROM productos WHERE id=:id');
    ...
    public function actualizar($articulo)
    {
        ...
        try {
            $query = $pdo->prepare('UPDATE productos SET nombre=:nombre, descripcion=:descripcion, precio= :precio, estado=:estado, url_foto = :url_foto WHERE id= :id');
