...
class Articulos_Model extends Model
{
    ...
    public function get()
    {
        ...
        try {
            ...
            $query = $this->db->connect()->query('SELECT IDProd, NomProd, Descripcion, Precio, Stock FROM articulos');
    ...
    public function verArticulo($id)
    {
        $articulo = null;
        try {
            $query = $this->db->connect()->prepare('SELECT IDProd, IDD, NomProd, Descripcion, Precio, Stock FROM productos WHERE id=:IDProd');
    ...
    public function actualizar($articulo)
    {
        ...
        try {
            $query = $pdo->prepare('UPDATE articulos SET nombre=:NomProd, descripcion=:Descripcion, precio= :Precio, stock=:Stock WHERE id= :IDProd');
